...
ActiveRecord::Schema.define(version: 20170122172941) do
  ...
  create_table "page_visits", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["page_id"], name: "index_page_visits_on_page_id", using: :btree
    t.index ["user_id"], name: "index_page_visits_on_user_id", using: :btree
  end
